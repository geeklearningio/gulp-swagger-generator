...
var Operation = (function () {
    function Operation(pathName, verb, path, method, context) {
        ...
        this.isJsonRequest = this.consumes.filter(function (x) { return x === "application/json"; }).length > 0;
        this.isJsonResponse = this.produces.filter(function (x) { return x === "application/json"; }).length > 0;
        this.isBinaryResponse = !this.isJsonResponse;
        this.isFormDataRequest = this.consumes.filter(function (x) { return x === "multipart/form-data"; }).length > 0;
